...
$campaign_list = get_campaign_list(implode(',', $grp_ids), 1);
...
<div class="local_sch01 local_sch">
    <form method="get" action="./paid_db_list.php" class="form-row" autocomplete="off" id="searchForm">
        ...
        <?php if ($where_sql){ ?><a href="./paid_db_list.php" class="btn btn_02">초기화</a><?php } ?>
