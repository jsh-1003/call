...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $i<count($list); $i++) {
            ...
            $send_result_at = isset($list[$i]['wr_1']) ? trim((string) $list[$i]['wr_1']) : '-';
            $send_result_msg = isset($list[$i]['wr_2']) ? trim((string) $list[$i]['wr_2']) : '0';
        ?>
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_msg"><?php echo $send_result_at ?></td>
            <td class="td_msg" style="font-weight:bold"><?php echo $send_result_msg ?></td>
